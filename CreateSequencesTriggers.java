...
public class CreateSequencesTriggers {
        ...
        try (Connection conn = DriverManager.getConnection(
            ...
            String[] triggers = {
                    ...
                    "CREATE OR REPLACE TRIGGER phone_id_trigger " +
                            "BEFORE INSERT ON Customer_Phone FOR EACH ROW " +
                            "BEGIN " +
                            "    :new.Phone_ID := phone_id_seq.NEXTVAL; " +
                            "END;",
                    "CREATE OR REPLACE TRIGGER email_trigger " +
                            "BEFORE INSERT ON Customer_Email FOR EACH ROW " +
                            "BEGIN " +
                    ...
                    "CREATE OR REPLACE TRIGGER equipment_type_id_trigger " +
                            "BEFORE INSERT ON Equipment_Type FOR EACH ROW " +
                            "BEGIN " +
                    ...
                    "CREATE OR REPLACE TRIGGER payment_history_id_trigger " +
                            "BEFORE INSERT ON Payment_History FOR EACH ROW " +
                            "BEGIN " +
                    ...
                    "CREATE OR REPLACE TRIGGER maintenance_id_trigger " +
                            "BEFORE INSERT ON Maintenance FOR EACH ROW " +
                            "BEGIN " +
            ...
            System.out.println("Sequences and triggers created successfully!");
